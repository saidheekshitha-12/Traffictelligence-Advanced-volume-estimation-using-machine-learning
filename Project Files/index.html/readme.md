...
<body background="https://cdn.vox-cdn.com/thumbor/voaR7sJfEKvT9L5NZw8xEPne6TDI=/0x78:3000x1766/1600x900/cdn.vox-cdn.com/uploads/chorus_image/image/44219366/72499026.0.0.jpg" text="black">
  ...
  <div class="login">
    ...
    <form action="{{ url_for('predict')}}" method="post">
      ...
      <label>minutes:</label>
      <input type="number" min="0" max="60" name="minutes" placeholder="minutes" required="required" /><br><br>
    ...
    <img src="data:image/png;base64,{{ plot }}" alt="Output Form" height="168" width="232" onerror="this.style.display='none';">
  </div>
</body>
</html>
